...
def capture_image(cam, filename, path):
    ...
    shifts the 16-bit data by 6 bits to fill a 16-bit range, 
    ...
    try:
        ...
        # Convert to uint16 (if not already) and shift left by 6 bits
        # 10-bit max is 1024. Shifted by 6 makes it 65520.
